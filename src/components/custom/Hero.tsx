        ...
        <React.Fragment>
            <section className='w-full h-auto flex flex-col lg:flex-row justify-between items-center bg-white px-3 py-5'>
                ...
                <div className='w-full max-w-[90%] lg:max-w-[30vw] flex flex-col justify-center items-center gap-5'>
                    ...
                    <p className='text-base max-md:text-sm text-justify'>
                        Let The Avinnya Skin and Asthetic Clinic be your trusted partner in unlocking the true potential of your skin, helping you radiate confidence and beauty with every treatment. Your path to healthy, glowing skin starts here.
                    </p>
                </div>
                    ...
                    <div className='h-auto my-12 py-12 bg-green-200 px-16 max-lg:px-6 rounded-l-4xl max-md:rounded-none w-full'>
                        ...
                        <div className='flex flex-col gap-2'>
                            ...
                            <p className='text-sm max-md:text-xs text-justify'>
                                Hair treatments at Avinnya Skin and Asthetic Clinic are designed to address a variety of hair concerns, including hair loss, thinning, and scalp issues. Our expert dermatologists offer a range of solutions, from non-invasive therapies to more advanced treatments like PRP (Platelet-Rich Plasma) therapy, aimed at stimulating hair growth and restoring thickness and volume. We work with you to create a tailored treatment plan to meet your unique hair restoration needs.
                            </p>
                        </div>
